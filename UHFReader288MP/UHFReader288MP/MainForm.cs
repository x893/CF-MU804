...
namespace UHFReader288MP
{
    public partial class MainForm : Form
    {
        ...
        private static void searchCB(IntPtr dev, IntPtr data)
        {
            ...
            // Get the searched device information:
            ...
            {
                // Add the searched device to the device list:
        ...
        private void Flash_G2()
        {
            ...
            CardNum = 0;
            fCmdRet = RWDev.Inventory_G2(ref fComAdr, Qvalue,
                Session, MaskMem, MaskAdr, MaskLen, MaskData,
                MaskFlag, tidAddr, tidLen, TIDFlag, Target,
                InAnt, Scantime, FastFlag, EPC,
                ref Ant, ref Totallen, ref TagNum, frmcomportindex);
        ...
        void InitForm()
        {
            ...
            panelCenter.Controls.Add(mReadInput);
            btnSetting.Select();
        }
        ...
        private void btnSetting_Click(object sender, EventArgs e)
        {
            ...
            panelCenter.Controls.Clear();
            panelCenter.Controls.Add(mSetting);
        }
